...
export default function News() {
    ...
    useEffect(() => {
        ...
        gsap.fromTo(heading0.current,
            { rotation: 3, scale: 1.2, opacity: 0, y: () => heading0.current.clientHeight * .54 },
            { rotation: 0, scale: 1, y: 0, opacity: 1, duration: 1.13, ease: 'power4.inOut', scrollTrigger: { trigger: heading1.current, start: 'center bottom' } })

        gsap.fromTo(heading1.current,
            { rotation: -3, opacity: 0, y: () => heading1.current.clientHeight * .54 },
            { rotation: 0, y: 0, opacity: 1, duration: 1.13, ease: 'power4.inOut', scrollTrigger: { trigger: heading1.current, start: 'center bottom' } })
    }, [])
